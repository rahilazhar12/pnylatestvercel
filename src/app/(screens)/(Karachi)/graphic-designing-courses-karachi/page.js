import Graphickarachi from "./Graphickarachi";




export default async function Digitalmarketing() {
  const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/graphic-designing-courses-karachi')
