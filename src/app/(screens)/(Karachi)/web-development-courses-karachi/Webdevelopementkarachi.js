    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'web-development-courses-karachi'}`
        );
...
export default Webdevelopementkarachi;
