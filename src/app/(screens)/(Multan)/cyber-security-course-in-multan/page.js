import Cybermultan from "./Cybermultan";
...
export default async function EmpowringProfessional() {
    const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/cyber-security-course-in-multan', {
        cache: 'no-cache'
    })
