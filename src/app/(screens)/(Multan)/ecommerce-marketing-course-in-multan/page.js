import Englishmultan from "./Ecommercemultan";



export default async function EmpowringProfessional() {
    const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/ecommerce-marketing-course-in-multan', {
        cache: 'no-cache'
    })
