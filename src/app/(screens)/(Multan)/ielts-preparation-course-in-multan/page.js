import Ieltsmultan from "./Ieltsmultan";
...
export default async function EmpowringProfessional() {
    const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/ielts-preparation-course-in-multan', {
        cache: 'no-cache'
    })
