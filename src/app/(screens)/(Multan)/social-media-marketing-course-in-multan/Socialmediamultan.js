        ...
        const fetchdatacitywise = async () => {
            ...
            try {
                let response = await axios.get(
                    `https://www.admin777.pny-trainings.com/api/city/specialpage/${'social-media-marketing-course-in-multan'}`
                );
...
export default Socialmediamultan;
