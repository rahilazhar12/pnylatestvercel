import Socialmediamultan from "./Socialmediamultan";



export default async function EmpowringProfessional() {
    const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/social-media-marketing-course-in-multan', {
        cache: 'no-cache'
    })
