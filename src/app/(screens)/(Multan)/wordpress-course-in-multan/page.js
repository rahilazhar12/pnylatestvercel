import Wordpresspmultan from "./Wordpressmultan";


export default async function EmpowringProfessional() {
    const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/wordpress-course-in-multan', {
        cache: 'no-cache'
    })
