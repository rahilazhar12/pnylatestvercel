import Seomultan from "./Youtubemultan";

export default async function EmpowringProfessional() {
    const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/youtube-training-course-in-multan', {
        cache: 'no-cache'
    })
