import Ecommercepindi from "./Ecommercepindi";

export default async function Freelancingcourse() {
  const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/e-commerce-course-in-rawalpindi', {
    cache: 'no-cache'
  })
