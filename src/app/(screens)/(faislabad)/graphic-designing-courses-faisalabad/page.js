import Graphicfaisl from "./Graphicfaisl";




export default async function Digitalmarketing() {
  const metadata = await fetch('https://www.admin777.pny-trainings.com/api/city/specialpage/graphic-designing-courses-faisalabad')
