...
const Webdevelopementfaislabad = () => {
  const { url } = useParams();
    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'web-development-courses-faisalabad'}`
        );
...
export default Webdevelopementfaislabad;
