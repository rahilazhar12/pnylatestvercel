    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin777.pny-trainings.com/api/city/specialpage/${'best-course-for-online-earning-in-pakistan'}`
        );
...
export default Bestcourseinlahore;
