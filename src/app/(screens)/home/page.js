...
import {
  ...
  Homecarousal,
} from "../../Components/Carousals/Carousal";
      ...
      <section className="bg-white">
        ...
        <div className="container mx-auto p-4 flex md:flex-col flex-col lg:flex-row xl:flex-row 2xl:flex-row md:items-center bg-white text-black">
          <div className=" flex-1 max-sm:order-1 px-2  max-sm:text-center md:text-center lg:text-center xl:text-start 2xl:text-start max-sm:p-3">
            ...
            <p className="mt-2  md:text-[48px] w-[400px] text-[20px] md:w-auto max-sm:w-auto font-semibold text-center">
              Pakistan's <span className="text-[#F10900]">No.1</span> IT
              Training Institute
            </p>
        ...
        <section>
          <div className="bg-white text-center p-8">
            <h2 className="text-2xl font-semibold mb-4 lgh text-black">
              We Develop Your Inspiring Career with Standard
            </h2>
            <p className="mb-8 mx-auto md:w-auto max-w-full  px-4 md:px-0 text-black">
            ...
            <div className="grid grid-cols-4 gap-4 max-sm:grid-cols-2 text-black">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className=" font-semibold ">100K Alumni</span>
              </div>
              <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className=" font-semibold ">300+ Instructors</span>
              </div>
              <div className="flex flex-col items-center">
                <FaHandshake className="text-4xl mb-2 text-blue-500" />
                <span className=" font-semibold ">100+ MoU's Sign</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-sm:mt-8 bg-gray-100 text-black">
          <div className="grid md:p-5 lg:space-y-5">
            <div className=" flex justify-center">
              <p className="lgh">Our Journey to success</p>
            </div>

            <div className="PNYTrainingsPakistan  justify-center flex">
              <p className=" lgp max-sm:text-base  md:text-base md:px-3 ">
          ...
          <div className="grid lg:grid-cols-2 md:grid-cols-2 xl:grid-cols-2 lg:px-20 lg:py-10 md:px-3 md:py-10 max-sm:p-1 ">
            <div className="max-sm:order-1 ">
              <div className="bg-blue-500 rounded-xl text-white xl:w-[541px] xl:h-[239px] xl:py-[47px] xl:px-[32px]  lg:w-[362px] lg:h-[200px] lg:px-[13px] lg:py-[26px] md:w-[362px] md:h-[200px] md:px-[10px] md:py-[20px] max-sm:px-3 max-sm:py-10">
                <div className="text-[30px] font-semibold max-sm:text-[24px]">
                  <span className="mr-3">
                    <i className="fa-solid fa-binoculars fa-fade"></i>
                  </span>
                  Our Vision{" "}
                </div>
                <div className=" text-[18px] md:text-[16px] max-sm:text-[16px] leading-7 font-normal xl:w-[480px]">
                  Our vision is to build a world where every young individual
                  has the skills and knowledge to thrive in the digital age. We
                  aim to be a catalyst for global innovation and socio-economic
                  development.
                </div>
              </div>
              ...
              <div className="bg-red-500 text-white rounded-xl mt-2 xl:py-[47px] xl:px-[32px] xl:w-[541px] xl:h-[311px] lg:w-[362px] lg:h-[250px] lg:px-[13px] lg:py-[26px] md:w-[362px] md:h-[250px] md:px-[10px] md:py-[20px]  max-sm:px-3 max-sm:py-10">
                <div className="text-[30px] font-semibold">
                  {" "}
                  <span className="mr-3">
                    <i className="fa-solid fa-bullseye fa-fade"></i>
                  </span>
                  Our Mission
                </div>
                <div className="text-[18px] font-normal xl:w-[480px] leading-7 max-sm:text-[16px]">
                  Our mission is to empower youth through accessible,
                  high-quality digital training and courses. We strive to foster
                  lifelong learning, inspire innovation, and create
              ...
              {data.slice(0, 6).map((item, index) => (
                <div key={index} className="col-span-4">
                  <div className="mainbox lg:h-96 xl:h-80 md:h-80 bg-gray-100 p-5 space-y-2 rounded">
                    ...
                    <div className="development lg:text-2xl font-semibold  font-Inter">
                      {item.name}
                    </div>
        ...
        <section className="bg-gray-50 md:p-5 text-black">
          <div className="grid grid-cols-12 gap-5 max-sm:grid-cols-6">
            <div className="col-span-6 max-sm:col-span-6 lg:col-span-6 lg:px-10 py-10 max-sm:order-1">
              <div className="whychooseus text-4xl font-bold max-sm:text-center  max-sm:text-2xl">
                Why Choose US?
              </div>
        ...
        <section className="lg:p-10 bg-white text-black">
          <div className="grid justify-center">
            <div className=" lgh lg:p-2 max-sm:mt-5  ">Our Affiliations</div>
        ...
        <section>
          <div
            id="trainer"
            className="grid space-y-3 max-sm:p-6 lg:px-48 lg:py-10 bg-[#F9FAFB] text-justify md:p-5 text-black"
          >
            <div className="grid">
              <div className="lgh ">Our trainers certified from</div>
