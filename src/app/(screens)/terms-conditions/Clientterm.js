    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(
          "https://www.admin777.pny-trainings.com/api/pages/terms-conditions"
        );
    ...
    <main>
      <section>
        <div className=" bg-[#152438] text-white h-[306px] flex flex-col justify-center items-center">
          <div className=" text-[48px] font-semibold  text-center max-sm:text-[32px]">
            Terms & Conditions
          </div>
          <div className=" text-[20px] font-normal w-[768px] max-sm:w-auto text-center max-sm:p-3 max-sm:text-[16px]">
            <p>
              This T&amp;C applies to all information submitted to&nbsp;PNY
              Trainings at any time through any of our services (from digital or
