...
const Trainingschedule1 = () => {
  ...
  return (
    <div className='bg-white'>
      ...
      <header className="text-gray-600 body-font px-10 bg-white">
                  ...
                  <div>
                    {getDivisions(batches[selectedCity]).map(division => (
                      <button key={division} onClick={() => handleDivisionClick(division)}>
                        <button type="button" className={`hover:text-white  from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300  font-medium rounded-lg text-sm px-2 py-2 text-center mr-2 mb-2 ${selectedDivision === division ? 'bg-[#308AFF] text-white' : 'bg-transparent border border-blue-700 hover:bg-blue-500'}`}>
                          {division}
                        </button>
                      </button>
                    ))}
      ...
      <div className="container mx-auto overflow-x-auto px-5 mt-5 bg-white">
